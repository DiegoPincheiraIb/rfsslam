...
N_c = 5; % number of expected clutter measurements per timestep
...
% PHD Filter Settings
sensor_limit_upper_buffer = 0.10;
sensor_limit_lower_buffer = 0.10;
particle_weighting_feautre_set_max_size = 5;
