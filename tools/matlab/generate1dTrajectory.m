function [p_k, c_k, d_k_km, D_vec_k_km] = generate1dTrajectory(k_max, dt, v_max)

% function generate1dTrajectory
% Keith Leung 2013
%
% Generate a straight line trajectory along the x-axis in 3d
%
% Inputs:
