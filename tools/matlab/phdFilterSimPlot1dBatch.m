...
%%
legend(h_robotTrajectory,'Groundtruth','Dead reckoning', 'Multi-feature strategy', 'Single-feature strategy', 'Empty-set strategy', 'Location', 'NorthWest')
legend(h_estimateError,'Dead reckoning', 'Multi-feature strategy', 'Single-feature strategy', 'Location', 'NorthWest')
legend(h_estimatedFeatureCount,'Groundtruth', 'Multi-feature strategy', 'Single-feature strategy', 'Location', 'NorthWest')
legend(h_mapEstimateError,'Multi-feature strategy', 'Single-feature strategy', 'Location', 'NorthWest')
